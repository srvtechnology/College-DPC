...
class ClassController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($data as $key => $values) {
            if (strpos($key, 'name') === 0) {
                ...
                {
                    $errorMsg[] = $classData->name.' already exists';
                }
        ...
        if(count($errorMsg) > 0)
        {
            $errorMsg[] = "Remain data saved successfully.";
            return redirect()->route("school.class")->with('errorMsg',$errorMsg);
        }
        else
        {
            return to_route("school.class")->with("success","Year Assign to Class Successfully");
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        return to_route("school.class")->with('success','Department Updated Successfully');
    }
    ...
    public function block(Request $request)
    {
        ...
        $class->save();
        return back()->with('success','Department Status Changed Successfully');
    }
