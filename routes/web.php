...
//     // $recipient = 'rishavbeas@gmail.com';
//     // $subject = 'My testing email';
//     // $message = 'sadasdad';
...
//     //         '--path' => 'database/migrations/2023_11_01_094037_add_column_random_pwd_string_to_users_table.php',
//     //     ]);
...
//     Route::get('/schools/{id}/students-list', 'studentList')->name('schools.students-list');
//     Route::get('/schools/{id}/teachers-list', 'teacherList')->name('schools.teachers-list');
//     Route::get('/schools/{id}/parents-list', 'parentList')->name('schools.parents-list');
// });
