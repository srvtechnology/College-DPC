                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <div class="form-group">
                                            <label for="field1">Video Url:</label><br>
                                            @if(!empty($study_material->video_url))
                                            <a href="{{ $study_material->video_url }}" class="btn btn-primary" target="_blank">Visit Video URL</a>&nbsp;
                                            @else
                                            <h6>N/A</h6>
                                            @endif
                                        </div>
