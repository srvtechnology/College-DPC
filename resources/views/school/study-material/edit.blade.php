                            ...
                            <div class="card-body">
                                <form id="myForm" action="{{ route("school.studyMaterial.update-content") }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                <label for="field1">File: <span class="text-muted">Max 10 MBs size (only PDF)</span></label>
                                                <input type="file" class="form-control @error('media') is-invalid @enderror" id="media"
                                                    name="media" value="{{ old('media') }}" accept=".pdf">
                                            </div>
                                            @error('media')
                                                <div class="text-danger">
                                                    {{ $message }}
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                <label for="field1">Video URL:</label>
                                                <input type="link" class="form-control" id="video_url"
                                                    name="video_url" value="{{ old('video_url',$study_material->video_url) }}">
                                            </div>
                                        </div>
