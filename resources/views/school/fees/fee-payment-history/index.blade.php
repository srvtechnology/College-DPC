            ...
            <div class="d-flex justify-content-between">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                        ...
                        <li class="breadcrumb-item active">Fees Payment History</li>
                    </ol>
                </nav>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($studentsfee_payment as $student_fee)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route("school.fees.fees-history.fee-payment-history-detail",$student_fee->student->id) }}" class="btn btn-success btn-sm" title="View Detail"><i class='bx bx-detail'></i></a>
