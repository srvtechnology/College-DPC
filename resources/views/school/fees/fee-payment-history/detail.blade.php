                ...
                <div class="col-md-12">
                    <div class="my-3">
                        ...
                        <div class="card">
                            ...
                            <h5 class="card-header">Fees Payment History</h5>
                            {{--  <a href="{{ route('school.fees.admin-fee-payment.create') }}" class="btn btn-primary">Fee payment</a>  --}}
                        </div>
                            <div class="table-responsive text-nowrap">
                                <table id="example" class="table table-striped" style="width:100%">
                                    ...
                                    <tbody>
                                        @if(count($student_all_fees) > 0)
                                        @foreach ($student_all_fees as $student_fee)
                                            ...
                                            <tr>
                                                ...
                                                <td><iframe src="{{ asset('uploads/schools/receipt/'.$student_fee->receipt) }}" frameborder="0" style="height: 150px;width:150px;"></iframe></td>
                                                <td>{{ $student_fee->date }}</td>
                                            </tr>
                                        @endforeach
                                        @endif
                                    </tbody>
