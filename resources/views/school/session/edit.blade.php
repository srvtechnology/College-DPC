                ...
                <div class="col-md-12">
                    <div class="my-3">
                        <div class="card mb-4">
                            <div class="card-body">
                                <x-alert></x-alert>
                                <form id="myForm" action="{{ route("school.view-all-session.update") }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title',$session->title) }}" id="title1">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="start_date" id="start_date"
                                                        class="form-control start_date" value="{{ old('start_date',$session->start_date) }}">
                                                    <div class="invalid-feedback">
                                                        Date is required
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="end_date" id="end_date"
                                                        class="form-control end_date" value="{{ old('end_date',$session->end_date) }}">
                                                    <div class="invalid-feedback">
                                                        Date is required
                                                    </div>
                                                </div>
