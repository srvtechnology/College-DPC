                                ...
                                <form id="myForm" action="{{ route('school.exam-timetable.store') }}" method="POST"
                                    ...
                                    <div id="innerForm">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="form-group">
                                                    <label for="field1">Total Marks:</label>
                                                    <input type="number" id="total_marks1"
                                                        class="form-control @error('total_marks1') is-invalid @enderror"
                                                        name="total_marks1" min="1"/>
        ...
        <script>
            ...
            $('#addField').click(function() {
                ...
                <div class="row"  id="field${fieldIndex}">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="form-group">
                            <label for="field${fieldIndex}">Start Date:</label>
