                                    ...
                                    <div id="innerForm">
                                        ...
                                        <div class="row"  id="field{{ $keyIndex }}">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="form-group">
                                                    <label for="field{{ $keyIndex }}">Start Date:</label>
                                                    <input type="date" name="date{{ $keyIndex }}" id="date{{ $keyIndex }}"
                                                        class="form-control date{{ $keyIndex }}" @if($exam_time_sheet->exam->date <= $timeSheetData->date) value="{{ $timeSheetData->date }}" @endif min="{{ $exam_time_sheet->exam->date }}">
                                                    <div class="invalid-feedback">
                                                        Date is required
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="form-group">
                                                    <label for="field{{ $keyIndex }}">Total Marks:</label>
                                                    <input type="number" id="total_marks{{ $keyIndex }}"
                                                        class="form-control @error('total_marks{{ $keyIndex }}') is-invalid @enderror"
                                                        name="total_marks{{ $keyIndex }}" min="1" value="{{ $timeSheetData->total_marks }}"/>
        ...
        <script>
            ...
            $('#addField').click(function() {
                ...
                <div class="row"  id="field${fieldIndex}">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="form-group">
                            <label for="field${fieldIndex}">Total Marks:</label>
                            <input type="number" id="total_marks${fieldIndex}"
                                class="form-control @error('total_marks${fieldIndex}') is-invalid @enderror"
                                name="total_marks${fieldIndex}" min="1"/>
                ...
                getExamDate(exam_id,fieldIndex);
                fieldIndex++;
            });
            ...
            function getExamDate(exam_id,fieldIndex)
            {
                $.ajax({
                    url: '{{ url('school/exams/exam-timetable/get-exam-date') }}' + '/' + exam_id,
                    type: 'GET',
                    success: function(response) {
                        $(".date"+fieldIndex).attr('min', response);
                    },
            ...
            function validateForm() {
                ...
                $('[id^=exam_id], [id^=class_id], [id^=subject_id], [id^=date], [id^=start_time], [id^=end_time],[id^=total_marks]')
                    .each(function() {
                        var field = $(this);
