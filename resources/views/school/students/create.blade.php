                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                    <div class="col-md-6 col-12 mb-3">
                                                        <div class="form-group">
                                                            <label for="">Guardian Name <span class="clr_red">*</span></label>
                                                            <input type="text" name="parent_name" id="parent_name"
                                                                class="form-control" placeholder="Name">
                                                            <span class="text-danger d-none" id="parent_name_error">Guardian Name
                                                                is
                                                                required</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12 mb-3">
                                                        <div class="form-group">
                                                            <label for="">Guardian Phone Number <span class="clr_red">*</span></label>
                                                            <input type="phone" name="parent_phone" id="parent_phone"
                                                                class="form-control" placeholder="Guardian Phone Number">
                                                            <span class="text-danger d-none" id="parent_phone_error">Guardian Phone Number
                                                                is
                                                                required</span>
                                                        </div>
                                                    </div>
