                        ...
                        <div class="card mb-4">
                            ...
                            {{--  <div class="row mb-2">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        ...
                                        <h5>{{ $student->school->username }}</h5>
                                    </div>
                                </div><hr>  --}}
                                <div class="row mb-2">
                                    <div class="col-md-12 mb-2 d-flex justify-content-between align-items-center">
                                        <h4 class="mb-0">Personal</h4>
                                        <a href="{{ route('school.students.pdf',['id' => $student->id]) }}" class="btn btn-success btn-sm"><i class="bx bxs-file-pdf"></i>Download Pdf</a>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="row">
                                            <div class="col-md-4 mb-2">
                                                <label>Image</label>
                                                <img src="{{ getStudentImage($student->id) }}" alt="" style="width: 150px;height: 150px;">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            {{--  <div class="col-md-4 mb-2">
                                                ...
                                                <h5>{{ $student->user->random_pwd_string }}</h5>
                                            </div>  --}}
                                            ...
                                            <div class="col-md-4 mb-2">
                                                ...
                                                <h5>{{ $student->reference_number }}</h5>
                                            </div>
                                            <div class="col-md-4 mb-2">
                                                <label>Registration Number</label>
                                                <h5>{{ $student->enroll_number }}</h5>
                                            </div>
                                            <div class="col-md-4 mb-2">
                                                <label>Student Unique ID</label>
                                                <h5>{{ $student->student_unique_id }}</h5>
                                            </div>
                                        </div>
                                    </div>
