                            ...
                            <form id="msform" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-3">
                                                    <label for="">First Name <span class="clr_red">*</span></label>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <div class="form-group">
                                                    <label for="">Last Name <span class="clr_red">*</span></label>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <div class="form-group">
                                                    <label for="">Phone<span class="clr_red">*</span></label>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <div class="form-group">
                                                    <label for="">Gender<span class="clr_red">*</span></label>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <div class="form-group">
                                                    <label for="">DOB<span class="clr_red">*</span></label>
                                            ...
                                            <div class="col-md-12 col-12 mb-3">
                                                <div class="form-group">
                                                    <label for="">Admission Date <span class="clr_red">*</span></label>
                                            ...
                                            <!--<div class="col-md-12 col-12  mb-3">-->
                                            <!--    <div class="form-group">-->
                                            <!--        <label for="">Temporary Address<span class="clr_red">*</span></label>-->
                                            ...
                                            <div class="col-md-12 col-12  mb-3">
                                                <div class="form-group">
                                                    <label for="">Permanent Address<span class="clr_red">*</span></label>
                                            ...
                                            <div class="col-md-12 col-12  mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="reference_number" id="reference_number"
                                                        ...
                                                        value="{{ $studentData->reference_number }}">
                                            ...
                                            <div class="col-md-12 col-12  mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="enrollment_number" id="enrollment_number"
                                                        class="form-control" placeholder="Enrollment Number"
                                                        value="{{ $studentData->enroll_number }}">

                                                </div>
                                            </div>
                                            <div class="col-md-12 col-12  mb-3">
                                                <div class="form-group">
                                                    <label for="">Student ID <span class="clr_red"></span></label>
                                                    <input type="text" name="unique_id" id="unique_id"
                                                        class="form-control" placeholder="Student Id"
                                                        value="{{ $studentData->student_unique_id }}">
                                                    <span class="text-danger d-none"
                                                        id="unique_id_error">Student ID is required</span>
                                                </div>
                                            </div>
                                        </div>
                                         <div class="row">
                                                    <div class="col-md-6 col-12 mb-3">
                                                        <div class="form-group">
                                                            <label for="">Gaurdian Name <span class="clr_red">*</span></label>
                                                            <input type="text" name="parent_name" id="parent_name"
                                                                class="form-control" placeholder="Name"
                                                                value="{{ $studentData->parent->name }}">
                                                            <span class="text-danger d-none" id="parent_name_error">Gaurdian Name
                                                                is
                                                                required</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12 mb-3">
                                                        <div class="form-group">
                                                            <label for="">Gaurdian Phone Number <span class="clr_red">*</span></label>
                                                            <input type="phone" name="parent_phone" id="parent_phone"
                                                                class="form-control" placeholder="Phone"
                                                                value="{{ $studentData->parent->phone }}">
                                                            <span class="text-danger d-none" id="parent_phone_error">Gaurdian Phone Number
                                                                is
                                                                required</span>
                                                        </div>
                                                    </div>
                                                    <!--<div class="col-md-6 col-12 mb-3">-->
                                                    <!--    <div class="form-group">-->
                                                    <!--        <label for="">Emergency Phone <span class="clr_red">*</span></label>-->
                                ...
                                <fieldset>
                                    <div class="form-card">
                                        <div class="row">
                                            <div class="col-7">
                                                <h2 class="fs-title">Department Assign:</h2>
                                            </div>
                                        </div>
                                        <div id="   ">
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group mb-3">
                                                        <label for="">Department <span class="clr_red">*</span></label>
                                                        ...
                                                        <span class="text-danger d-none" id="class_id_error">Department is
                                                            required</span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group mb-3">
                                                        <label for="">Year <span class="clr_red">*</span></label>
                                                        ...
                                                        <span class="text-danger d-none" id="section_id_error">Year is
                                                            required</span>
                                                    </div>
                                                </div>
                                                {{--  <div class="col-md-6 col-12">
                                    ...
                                    <input type="hidden"  name="parent_type" value="new_parent">
                                    <input type="hidden" name="parent_id" value="{{ $studentData->parent_id }}">
                                ...
                                <!--            <div class="col-md-6 col-12 mb-3">-->
                                <!--                <div class="form-group">-->
                                <!--                    <label for="">Department Name <span class="clr_red">*</span></label>-->
                                <!--                    <input type="text" name="bg_class_name" id="bg_class_name"-->
                                <!--                        class="form-control" placeholder="Last Name"-->
                                <!--                        value="{{ $studentData->bg_class_name }}">-->
                                <!--                    <span class="text-danger d-none" id="bg_class_name_error">Department Name-->
                                <!--                        is-->
                                <!--                        required</span>-->
                                <!--                </div>-->
                                <!--            </div>-->
                                    ...
                                    <div class="form-card">
                                        ...
                                        <div id="   ">
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group mb-3">
                                                        <label for="">Fee <span class="clr_red">*</span></label>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group mb-3">
                                                        <label for="">Fee Amount<span class="clr_red">*</span></label>
                                                        <input type="number" id="fee_amount" class="form-control"
                                                            name="fee_amount" value="{{ !empty($studentData->fees) ? $studentData->fees->amount : '' }}" readonly>
                                                            <input type="hidden" id="fee_structure_id" name="fee_structure_id" value="{{ @$studentData->fees->fee_structure_id }}">
                                ...
                                <!--                        <div class="form-group mb-3">-->
                                <!--                            <label for="">Select Student <span class="clr_red">*</span></label>-->
                                ...
                                <!--                    <div class="col-md-12 col-12">-->
                                <!--                        <div class="form-group mb-3">-->
                                <!--                            <label for="">Select Staff <span class="clr_red">*</span></label>-->
                                ...
                                <!--                    <div class="col-md-6 col-12 mb-3">-->
                                <!--                        <div class="form-group">-->
                                <!--                            <label for="">Name <span class="clr_red">*</span></label>-->
                                <!--                            <input type="text" name="parent_name" id="parent_name"-->
                                <!--                                class="form-control" placeholder="Name"-->
                                <!--                                value="{{ $studentData->parent->name }}">-->
                ...
                $('#class_id').on('change', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if(response.fee_structure)
                            {
                                $("#fee_structure_id").val(response.fee_structure.id);
                                $("#fee_amount").val(response.fee_structure.amount);
                            }
                            else
                            {
