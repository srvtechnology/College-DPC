                                    ...
                                    <tbody>
                                        @foreach ($leave_applications as $key => $leave_application)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success btn-sm text-white acceptBtn" title="Accept" data-id={{ $leave_application->id }} data-url={{ route("school.leave-applications.accept") }}><i class='bx bx-check-square'></i></a>&nbsp;
                                                    <a class="btn btn-danger btn-sm text-white rejectBtn" title="Reject" data-id={{ $leave_application->id }} data-url={{ route("school.leave-applications.rejected") }}><i class='bx bx-x'></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
