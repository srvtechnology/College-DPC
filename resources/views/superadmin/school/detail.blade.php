        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <h5>{{ $school->user->random_pwd_string }}</h5>
                                    </div>
                                    <div class="col-md-6 mb-3">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-6 mb-4">
                    ...
                    <a href="{{ route('superadmin.schools.students-list', $school->id) }}" target="_blank">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <span class="fw-semibold d-block mb-1">List of Students</span>
                ...
                <div class="col-lg-4 col-md-4 col-6 mb-4">
                    <a href="{{ route('superadmin.schools.teachers-list', $school->id) }}" target="_blank">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                ...
                                <span class="fw-semibold d-block mb-1">List of Teachers</span>
                                <h3 class="card-title mb-2">{{ $total_teachers }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-6 mb-4">
                    <a href="{{ route('superadmin.schools.parents-list', $school->id) }}" target="_blank">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                ...
                                <span class="fw-semibold d-block mb-1">List of Parents</span>
